...
namespace {
struct qt_meta_tag_ZN4CoinE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN4CoinE = QtMocHelpers::stringData(
    "Coin",
    "coinCollected",
    "",
    "value"
...
Q_CONSTINIT static const uint qt_meta_data_ZN4CoinE[] = {
...
Q_CONSTINIT const QMetaObject Coin::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN4CoinE.offsetsAndSizes,
    qt_meta_data_ZN4CoinE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN4CoinE_t,
        // Q_OBJECT / Q_GADGET
...
void Coin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->coinCollected((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Coin::*)(int );
            if (_q_method_type _q_method = &Coin::coinCollected; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Coin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN4CoinE.stringdata0))
...
// SIGNAL 0
void Coin::coinCollected(int _t1)
{
