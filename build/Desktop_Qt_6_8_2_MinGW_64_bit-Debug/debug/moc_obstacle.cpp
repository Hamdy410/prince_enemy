...
static constexpr auto qt_meta_stringdata_ZN8ObstacleE = QtMocHelpers::stringData(
    "Obstacle"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN8ObstacleE[] = {
...
Q_CONSTINIT const QMetaObject Obstacle::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8ObstacleE.offsetsAndSizes,
    qt_meta_data_ZN8ObstacleE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8ObstacleE_t,
        // Q_OBJECT / Q_GADGET
...
void *Obstacle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8ObstacleE.stringdata0))
