...
static constexpr auto qt_meta_stringdata_ZN12Level2WindowE = QtMocHelpers::stringData(
    "Level2Window",
    "Level3Requested",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12Level2WindowE[] = {
...
Q_CONSTINIT const QMetaObject Level2Window::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12Level2WindowE.offsetsAndSizes,
    qt_meta_data_ZN12Level2WindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12Level2WindowE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Level2Window, std::true_type>,
        // method 'Level3Requested'
...
void Level2Window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->Level3Requested(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Level2Window::*)();
            if (_q_method_type _q_method = &Level2Window::Level3Requested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Level2Window::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12Level2WindowE.stringdata0))
...
// SIGNAL 0
void Level2Window::Level3Requested()
{
